...
class Settings:
    ...
    # --- Sandbox execution ------------------------------------------------------
    # "subprocess" is the default: no Docker required, code runs directly on
    # this machine. Switch to "docker" (see backend/README.md) once you want
    # real sandboxing — nothing else in the code needs to change.
    executor_backend: str = os.getenv("EXECUTOR_BACKEND", "subprocess")  # "docker" | "subprocess"
